        ...
        >
          ...
          >
            <div className="flex items-start justify-between">
              <h3 className="text-lg font-semibold">Send setup guide to hotel</h3>
              <button
                type="button"
                onClick={() => setOpen(false)}
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-stretch gap-2">
                <code className="flex-1 overflow-x-auto rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-sm text-zinc-700 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300">
                  {guideUrl}
                </code>
                <button
                  type="button"
              ...
              <div className="grid grid-cols-2 gap-2">
                <a
                  href={downloadHref}
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#1A56DB] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1648b0]"
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4">
                ...
                <a
                  href={mailtoHref}
                  onClick={() => track("email")}
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-300 px-4 py-2 text-sm font-medium hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800"
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4">
            ...
            <p className="mt-4 rounded-lg bg-zinc-50 p-3 text-sm text-zinc-600 dark:bg-zinc-900 dark:text-zinc-400">
